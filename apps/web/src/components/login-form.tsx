    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {isRegisterMode ? "Sign up with your Google account" : "Login with your Google account"}
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <FieldGroup>
              <Field>
                <Button variant="outline" type="button" onClick={loginWithGoogle}>
                  ...
                  {isRegisterMode ? "Sign up" : "Login"} with Google
                </Button>
              </Field>
              ...
              {mutation.isError && (
                <p className="text-red-500 text-sm">
                  {isRegisterMode ? "Registration failed. Email may already exist." : "Login failed. Check your credentials."}
                </p>
              )}
              <Field>
                <Button type="submit" disabled={mutation.isPending}>
                  {mutation.isPending ? (isRegisterMode ? "Creating account..." : "Signing in...") : (isRegisterMode ? "Create Account" : "Login")}
                </Button>
